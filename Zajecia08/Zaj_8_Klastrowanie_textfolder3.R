...
docs <- DirSource("C:/Users/Mikołaj/Desktop/studia/psi/textfolder3")
...
#' 
#'  Nie do końca, klastry wskazują słowa takie jak "people", "country", "america"
#'  na podstawie których można wywnioskować, że są to przemówienia polityczne,
#' jednak nie mamy informacji jakie konkretnie kwestie są poruszane w tych przemówieniach
#'
#'  2- Jakich ogólnie obszarów tematycznych dotyczą klastry oraz ile jest tych obszarów?
#'
#'  Klastry dotyczą ogólnej polityki (społeczeństwo, gospodarka, sprawy państwowe).
#'  Podzielone zostały na 2, 3 i 4 klastry, ale wszystkie wyniki są do siebie podobne,
#'  więc jest tylko jeden obszar tematyczny
